...
$details = mySelect($link,'*','bbs_details','first!=0 and isdel=0');//当isdel = 0的时候在这个页面显示，不为零的时候不显示

//查询出大板块的内容，主要是查询出帖子的内容时，还有涉及到大板块的一些信息之类的:例如板块名称
$category  =mySelect($link,'*','bbs_category','parentid !=0');

//查询帖子的数量，利用count函数
$num = mySelect($link,'count(*)','bbs_details','first!=0 and isdel=0');
...
display('after4_2.html',compact('details','category','num','result'));