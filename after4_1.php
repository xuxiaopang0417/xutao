...
$details = mySelect($link,'*','bbs_details','first=1 and isdel=1');//当isdel = 0的时候在这个页面显示，不为零的时候不显示
...
//查询帖子的数量，利用count函数
$num = mySelect($link,'count(*)','bbs_details','first=1 and isdel=1');
...
display('after4_1.html',compact('details','category','num','result'));
