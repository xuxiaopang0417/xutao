...
<div class="site-information-head" >
    ...
    <div class="site-information-head-nav">
        ...
        <ul>
            ...
            <li  style="background-color:#1297c9; "><a href="after4.html" style="color: #fff;">帖子管理</a></li>
    ...
    <div class="site-information-content-right">
        <div class="site-information-content-right-index4">
            ...
            <ul>
                ...
                <li>
                    <span style="padding-left: 40px;">标题</span>
                    <span  style="padding-left: 400px;">版块</span>
                    <span  style="padding-left: 70px;">作者</span>
                    <span  style="padding-left: 70px;">回复</span>
                    <span  style="padding-left: 70px;">浏览</span>
                    <span  style="padding-left: 60px;">最后发表</span>
              ...
              <form action="admin_Plate4_1.php"method="post"enctype="multipart/form-data">
                ...
                <li style="position: relative;">
                    ...
                    <!--通过上面的遍历，用数组形式写法实现多选-->
                    <span style="padding-left: 22px;display: inline-block;width: 340px;height: 30px;overflow: hidden;"><a href="#"><?php echo $value['title'];?></a></span>
                    <div  style="position: absolute;left:220px;top:0;">
                        ...
                        <span style="padding-left: 60px;"><?php echo $value['replycount'];?></span>
                        <span style="padding-left: 93px;"><?php echo $value['hits'];?></span>
                        <span style="padding-left: 77px;"><?php echo $value['addtime'];?></span>
                    </div>
                </li>
